...
| `geobounds` | Download and import administrative boundaries from geoBoundaries |
| `geodata` | Download and import administrative boundaries, elevation, WorldClim data, etc. |
...
| `forestdata` | Download forestry and land cover data |
