...
The required data is available on the GitHub repository (<https://github.com/jguelat/R-GIS>{target="_blank"}). You'll also find all the code needed to re-create the whole book.


# Changelog {.unnumbered}

Only the big updates are listed here... Typo and bug fixes are not listed... Make a table

- 2025-02-25: Update of the `tmap` subsections (static and dynamic maps), compatibility with `tmap 4`, more explanation and map examples.
