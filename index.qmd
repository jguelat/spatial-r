...
| | |
|------------|------------|
| 2026-03-04 | Update of the coordinate reference systems chapter, new examples for vectors |
| 2026-02-17 | Better explanations and more examples in the raster extraction subsection |
| 2025-09-22 | Update of the basic maps subsection, more explanations and examples |
...
And the following packages (the dependencies are not listed):
